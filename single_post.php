...
<title>
    <?php echo $post['title'] ?> | THE BLOOOOG</title>
...
<body>
    ...
    <!-- // Navbar -->
    <div class="container ">
        <h1 class="post-title display-4 font-weight-bold col-md-12">
            <?php echo $post['title']; ?>
        </h1>
...
">
                    ...
                    <div class="card-content text-center">
                        ...
                        <a class="h5" href="<?php echo BASE_URL . 'filtered_posts.php?topic=' . $topic['id'] ?>">
